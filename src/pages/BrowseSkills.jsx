                   ...
                   {error && (
                        <div className="flex flex-col items-center justify-center py-20 gap-3 text-center">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-accent/10 border border-accent/20 text-accent font-satoshi text-sm font-semibold hover:bg-accent/20 hover:border-accent/40 transition-all duration-300"
                            >
